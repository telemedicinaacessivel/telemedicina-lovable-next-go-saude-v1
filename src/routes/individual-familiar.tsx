...
const PLAN_TIERS = [
  ...
  },
  {
    ...
    familyUrl: "https://app.nextgosaude.com.br/public/plans/76419ac0-b747-42f4-91f0-1c192140153c",
...
function FAQ() {
  const faqs = [
    ...
    { q: "Quais são as especialidades médicas disponíveis?", a: "Especialidades disponíveis para você e sua família: Psicologia adulto; Psicologia Infantil (incluindo TEA)a partir de 4 anos; Psiquiatria adulto a partir de 16 anos; Nutrição (adulto e infantil); Dermatologia –(adulto e infantil); Cardiologia (adulto e infantil); Clínico da Família; Clínico Geral; Endocrinologia a partir de 16 anos; Geriatria +6; Ginecologia a partir de 12 anos; Neurologia  a partir de 14 anos; Ortopedia –(adulto e infantil); Otorrinolaringologia (adulto e infantil a partir de 6 anos); Pediatria; Traumatologia (adulto e infantil); Urologia (adulto e infantil)" },
