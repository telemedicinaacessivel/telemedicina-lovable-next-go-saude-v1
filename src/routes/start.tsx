          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Obrigado! Já recebemos seus dados com segurança. Estamos te encaminhando agora…
              </p>
              ...
              <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
                ...
                >
                  {form.formState.isSubmitting ? (
                    <span className="inline-flex items-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Enviando…</span>
                  ) : (
                    "Continuar →"
                  )}
                </Button>
